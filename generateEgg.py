...
class generateModel(ShowBase):
    def __init__(self):
        ShowBase.__init__(self)
        self.generateEgg()
        model = loader.loadModel("models/generated.egg")
    ...
    def generateEgg(self):
        ...
        texture = EggTexture("color", Filename("textures/woodcrate_front.png"))
        ...
        eggRoot.writeEgg(Filename("models/wood_box.egg"))
